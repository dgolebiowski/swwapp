...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<title>Download Apki</title>
	
</head>
<body class="permission_denied">
  <div id="particles-js"></div>
  <div class="denied__wrapper">
    <h3>Pobierz apkę klikając guzik na dole :D</h3>
    ...
    <a href="/download/koperapp.apk"><button class="denied__link">Chciałeś pobrać apke? Klik </button></a>
  </div>
  <script>
  var particles = {
      "particles": {
