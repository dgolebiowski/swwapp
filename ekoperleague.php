...
Kliknij na drużynę jeśli chcesz więcej informacji o niej.<br>
...
<?php 
  $listaeventy = mysql_query("SELECT * FROM gamesekl ORDER BY `id` ASC") or die(mysql_error());
	 ...
	 echo '<div class="mecz-item">
		...
		<div class="mecz-center">
			...
			<div class="mecz-obstaw"> 
				<a href="obstawe.php?id=' . $row[0] .'"><div class="obstaw-text"> OBSTAW MECZ</div></a>
			</div>
		</div>
